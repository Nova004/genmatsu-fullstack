# 🔍 ตรวจสอบละเอียด: เมื่อกด "Drafted" ปุ่มจะเกิดอะไร

---

## 📍 จุดเริ่มต้น: ปุ่ม "Drafted"
...
|---|---|---|---|---|
| 1 | Ironpowder_index.tsx | Click "Drafted" | ✅ | onDraft callback |
...
**สรุป:** ระบบ Drafted feature ทำงานครบถ้วนตามสถาปัตยกรรม ✅
