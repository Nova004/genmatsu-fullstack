...
interface OutputProductGenmatsuAProps {
...
const OutputProductGenmatsuA: React.FC<OutputProductGenmatsuAProps> = ({
  ...
  const handleAddRow = () => {
    append({ canNo: '', temperature: '', weight: undefined });
  };
              ...
              <tr key={field.id}>
                ...
                <td className={tdCenterClass}>
                  <input
                    ...
                    className={inputClass}
                    placeholder=""
                    {...register(`${fieldName}.${index}.temperature`)}
                  />
                </td>
...
export default OutputProductGenmatsuA;
