                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="my-6">
                        ...
                        <div className={step !== 3 ? 'hidden' : ''}>
                            <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={handleTemplateLoaded} templateName="BS_Step3_Operations" />
                        </div>
