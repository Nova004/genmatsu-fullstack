// src/components/formGen/pages/BS_Form/BSFormViewer.tsx
...
// สร้าง Interface เพื่อกำหนดว่า BSFormViewer ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface BSFormViewerProps {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['BS_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['BS_Step3_Operations']} templateName="BS_Step3_Operations" />}
