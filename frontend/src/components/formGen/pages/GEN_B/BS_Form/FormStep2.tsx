          ...
          <table className="w-full table-auto">
            <tbody>
              <tr>
                ...
                <td className={tdLeftClass}> <div className="flex items-center"> <input type="number" step="0.001" className={inputClass} {...register('cg1cWeighting.row1.cg1c', { valueAsNumber: true, required: 'กรุณากรอก CG-1C Weight ROW 1' })} /> <span className="ml-2">KG</span></div>
              ...
              <tr>
                <td className={tdLeftClass}>CG-1C Weight</td>
                <td className={tdLeftClass}> <div className="flex items-center"> <input type="number" step="0.001" className={inputClass} {...register('cg1cWeighting.row2.cg1c', { valueAsNumber: true, required: 'กรุณากรอก CG-1C Weight ROW 2' })} /><span className="ml-2">KG</span></div>
              ...
              <tr>
                ...
                <td className={tdLeftClass}><div className="flex items-center"><input type="number" step="0.001" className={inputClass} {...register('calculations.nacl15SpecGrav', { valueAsNumber: true, required: 'กรุณากรอก 4% NaCl Water Specific gravity' })} /><span className="ml-2">KG/L</span></div>
