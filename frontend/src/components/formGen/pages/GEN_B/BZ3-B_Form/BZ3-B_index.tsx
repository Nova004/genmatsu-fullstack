// frontend/src/components/formGen/pages/BZ3-B_Form/BZ3-B_index.tsx (โค้ดใหม่)
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="my-6">
                        ...
                        <div className={step !== 3 ? 'hidden' : ''}>
                            <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={handleTemplateLoaded} templateName="BZ3-B_Step3_Operations" />
                        </div>
                        <div className={step !== 4 ? 'hidden' : ''}>
                            <SharedFormStep4 register={register} watch={watch} setValue={setValue} totalWeightFieldName="bz3Calculations.totalWeightWithNcr" />
                        </div>
                    </div>
