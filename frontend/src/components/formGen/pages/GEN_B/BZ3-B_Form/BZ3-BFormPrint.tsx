// location: frontend/src/components/formGen/pages/BZ3-B_Form/BZ3-BFormPrint.tsx
...
// สร้าง Interface เพื่อกำหนดว่า BZ3-BFormPrint ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface BZ3_BFormPrintProps {
...
// --- ส่วน Component หลัก ---
const BZ3_BFormPrint: React.FC<BZ3_BFormPrintProps> = ({ formData, blueprints, isReadOnly, approvalFlowComponent }) => {
      ...
      <div className="a4-page-container rounded-sm border border-stroke bg-white dark:border-strokedark dark:bg-boxdark flex flex-col"> {/* 👈 เปลี่ยน */}
        ...
        <div className="flex w-full flex-col border-r border-stroke dark:border-strokedark"> {/* 👈 เปลี่ยน */}
          ...
          <div className="form-section p-1 md:p-1 border-b border-stroke dark:border-strokedark">
            {/* ผมเดาว่า Component Step 1 ของ BZ3-B น่าจะชื่อประมาณนี้นะครับ */}
          ...
          <div className="form-section print-step3-compact p-2 md:p-4 border-b border-stroke dark:border-strokedark">
            {/* ผมเดาว่า Component Step 2 ของ BZ3-B น่าจะชื่อประมาณนี้นะครับ */}
            {/* และต้องส่ง Blueprint ที่ถูกต้องเข้าไปด้วย */}
            <FormStep2 {...formStepProps} staticBlueprint={blueprints['BZ3-B_Step2_RawMaterials']} />
          </div>
        </div>
        ...
        >
          ...
          <div className="form-section p-2 md:p-4 border-b border-stroke dark:border-strokedark">
            ...
            <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['BZ3-B_Step3_Operations']} templateName="BZ3-B_Step3_Operations" />
          </div>
        ...
        >
          <div className="form-section p-2 md:p-4">
            {/* ผมเดาว่า Component Step 4 ของ BZ3-B น่าจะชื่อประมาณนี้นะครับ */}
            <SharedFormStep4 {...formStepProps} totalWeightFieldName="bz3Calculations.totalWeightWithNcr" />
          </div>
        </div>
