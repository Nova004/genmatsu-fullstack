...
// สร้าง Interface เพื่อกำหนดว่า BZ3-BFormViewer ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface BZ3_BFormViewerProps {
...
// --- ส่วน Component หลัก ---
const BZ3_BFormViewer: React.FC<BZ3_BFormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        <FormHeader
          ...
          formTypes={[{ value: 'BZ3-B', label: 'BZ3-B', path: '#' }]}
          currentValue="BZ3-B"
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['BZ3-B_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['BZ3-B_Step3_Operations']} templateName="BZ3-B_Step3_Operations" />}
...
export default BZ3_BFormViewer;