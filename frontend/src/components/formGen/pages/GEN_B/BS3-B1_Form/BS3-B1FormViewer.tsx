...
// สร้าง Interface เพื่อกำหนดว่า BS3-B1FormViewer ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface BS3_B1FormViewerProps {
...
// --- ส่วน Component หลัก ---
const BS3_B1FormViewer: React.FC<BS3_B1FormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        <FormHeader
          ...
          formTypes={[{ value: 'BS3-B1', label: 'BS3-B1', path: '#' }]}
          currentValue="BS3-B1"
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['BS3-B1_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['BS3-B1_Step3_Operations']} templateName="BS3-B1_Step3_Operations" />}
...
export default BS3_B1FormViewer;