...
// สร้าง Interface เพื่อกำหนดว่า BS3-BFormViewer ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface BS3_BFormViewerProps {
...
// --- ส่วน Component หลัก ---
const BS3_BFormViewer: React.FC<BS3_BFormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        <FormHeader
          ...
          formTypes={[{ value: 'BS3-B', label: 'BS3-B', path: '#' }]}
          currentValue="BS3-B"
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['BS3-B_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['BS3-B_Step3_Operations']} templateName="BS3-B_Step3_Operations" />}
...
export default BS3_BFormViewer;