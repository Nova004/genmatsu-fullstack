...
const BS3_BFormEdit: React.FC<BS3_BFormEditProps> = ({ initialData, onSubmit, onResubmit, submissionId, status }) => {
    const totalSteps = 4;
    ...
    const availableForms = [{ value: 'BS3-B', label: 'BS3-B', path: '#' }]; // ไม่จำเป็นต้องมี path จริงในโหมดแก้ไข
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                ...
                <div className="my-6">
                    ...
                    */}
                    ...
                    {step === 3 && <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={() => { }} templateName="BS3-B_Step3_Operations" />}
