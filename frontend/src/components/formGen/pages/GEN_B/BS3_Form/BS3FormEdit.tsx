...
const BS3FormEdit: React.FC<BS3FormEditProps> = ({ initialData, onSubmit, onResubmit, status, templates }) => {
    const totalSteps = 4;
    ...
    const availableForms = [{ value: 'G017', label: 'BS3', path: '#' }]; // ไม่จำเป็นต้องมี path จริงในโหมดแก้ไข
                    ...
                    */}
                    ...
                    {step === 2 && (
                        <FormStep2
                            ...
                            staticBlueprint={status === 'Approved' && templates ? templates['BS3_Step2_RawMaterials'] : undefined}
                        />
                    )}
                    {step === 3 && (
                        <SharedFormStep3
                            ...
                            getValues={getValues}
                            onTemplateLoaded={() => { }}
                            templateName="BS3_Step3_Operations"
                            // 👇 Pass logic Approved ? Old : New
                            staticBlueprint={status === 'Approved' && templates ? templates['BS3_Step3_Operations'] : undefined}
                        />
                    )}
