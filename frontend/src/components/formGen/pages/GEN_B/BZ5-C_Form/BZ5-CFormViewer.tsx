...
// สร้าง Interface เพื่อกำหนดว่า BZ5-CFormViewer ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface BZ5_CFormViewerProps {
...
// --- ส่วน Component หลัก ---
const BZ5_CFormViewer: React.FC<BZ5_CFormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
  ...
  return (
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        <FormHeader
          title="ใบรายงานการผลิต (BZ5-C)"
          formTypes={[{ value: 'BZ5-C', label: 'BZ5-C', path: '#' }]}
          currentValue="BZ5-C"
        ...
        <div className="my-6">
          ...
          {step === 1 && <SharedFormStep1 {...formStepProps} packagingWarningItemName="CDZ-1" />}
          {/* ถ้า `step` เท่ากับ 2 ให้แสดง <FormStep2> และส่ง `staticBlueprint` ที่ถูกต้องเข้าไปด้วย */}
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['BZ5-C_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['BZ5-C_Step3_Operations']} templateName="BZ5-C_Step3_Operations" />}
...
export default BZ5_CFormViewer;