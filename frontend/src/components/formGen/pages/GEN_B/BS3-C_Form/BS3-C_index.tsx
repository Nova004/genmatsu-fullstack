// frontend/src/components/formGen/pages/BS3-C_Form/BS3-C_index.tsx (โค้ดใหม่)
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="my-6">
                        ...
                        <div className={step !== 3 ? 'hidden' : ''}>
                            <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={handleTemplateLoaded} templateName="BS3-C_Step3_Operations" />
                        </div>
