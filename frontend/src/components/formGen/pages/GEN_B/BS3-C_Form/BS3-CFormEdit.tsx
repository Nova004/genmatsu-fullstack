...
const BS3_CFormEdit: React.FC<BS3_CFormEditProps> = ({ initialData, onSubmit, onResubmit, submissionId, status }) => {
    const totalSteps = 4;
    ...
    const availableForms = [{ value: 'BS3-C', label: 'BS3-C', path: '#' }]; // ไม่จำเป็นต้องมี path จริงในโหมดแก้ไข
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                ...
                <div className="my-6">
                    ...
                    */}
                    ...
                    {step === 3 && <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={() => { }} templateName="BS3-C_Step3_Operations" />}
