// location: frontend/src/components/formGen/pages/BS3-C_Form/BS3-CFormEdit.tsx
...
const BS3_CFormEdit: React.FC<BS3_CFormEditProps> = ({ initialData, onSubmit, onResubmit, status, templates }) => {
    const totalSteps = 4;
    ...
    const availableForms = [{ value: 'G025', label: 'BS3-C', path: '#' }]; // ไม่จำเป็นต้องมี path จริงในโหมดแก้ไข
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                <FormHeader
                    title="แก้ไขใบรายงานการผลิต (BS3-C)" // เปลี่ยน Title สำหรับหน้าแก้ไข
                    ...
                    */}
                    ...
                    {step === 2 && (
                        <FormStep2
                            ...
                            staticBlueprint={status === 'Approved' && templates ? templates['BS3-C_Step2_RawMaterials'] : undefined}
                        />
                    )}
                    {step === 3 && (
                        <SharedFormStep3
                            ...
                            getValues={getValues}
                            onTemplateLoaded={() => { }}
                            templateName="BS3-C_Step3_Operations"
                            // 👇 Pass logic Approved ? Old : New
                            staticBlueprint={status === 'Approved' && templates ? templates['BS3-C_Step3_Operations'] : undefined}
                        />
                    )}
