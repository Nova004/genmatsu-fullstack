// src/pages/BS3-C_Form/FormStep2.tsx
...
export const useBS3_CCalculations = (
  ...
  useEffect(() => {
    ...
    console.log("🚀 --- [START] เริ่มการคำนวณ BS3-C --- 🚀");
    ...
    setValue('bs3Calculations.totalWeightWithNcr', formatNumberRound(totalWeightWithNcrResult) as any);
    console.groupEnd();

    console.log("🚀 --- [END] สิ้นสุดการคำนวณ BS3-C --- 🚀");
...
const FormStep2: React.FC<FormStep2Props> = ({
  ...
  const { fields, isLoading, error } = useTemplateLoader({
    templateName: 'BS3-C_Step2_RawMaterials', // 👈 แค่ระบุชื่อ Template ที่ถูกต้อง
    onTemplateLoaded,
    staticBlueprint,
  });

  useWeightingCalculation(watch, setValue, bs3WeightingConfig);
  useBS3_CCalculations(watch, setValue);
          ...
          <table className="w-full table-auto">
            <tbody>
              ...
              <tr>
                ...
                <td className={tdLeftClass}> <span className="text-xs">Weight of RC-417 + Mg(OH)2 + Gypsum + Carbon HR5</span> </td>
