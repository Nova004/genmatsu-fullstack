// location: frontend/src/components/formGen/pages/BN_Form/BNFormPrint.tsx
...
// สร้าง Interface เพื่อกำหนดว่า BNFormPrint ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface BNFormPrintProps {
...
// --- ส่วน Component หลัก ---
const BNFormPrint: React.FC<BNFormPrintProps> = ({ formData, blueprints, isReadOnly, approvalFlowComponent }) => {
      ...
      <div className="a4-page-container rounded-sm border border-stroke bg-white dark:border-strokedark dark:bg-boxdark flex flex-col"> {/* 👈 เปลี่ยน */}
        ...
        <div className="flex w-full flex-col border-r border-stroke dark:border-strokedark"> {/* 👈 เปลี่ยน */}
          ...
          <div className="form-section p-1 md:p-1 border-b border-stroke dark:border-strokedark">
            ...
            <SharedFormStep1 {...formStepProps} packagingWarningItemName="Zeolite (Z)" />
          </div>
          ...
          <div className="form-section print-step3-compact p-2 md:p-4 border-b border-stroke dark:border-strokedark">
            {/* ผมเดาว่า Component Step 2 ของ BN น่าจะชื่อประมาณนี้นะครับ */}
            {/* และต้องส่ง Blueprint ที่ถูกต้องเข้าไปด้วย */}
            <FormStep2 {...formStepProps} staticBlueprint={blueprints['BN_Step2_RawMaterials']} />
          </div>
        </div>
        ...
        >
          ...
          <div className="form-section p-2 md:p-4 border-b border-stroke dark:border-strokedark">
            ...
            <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['BN_Step3_Operations']} templateName="BN_Step3_Operations" />
          </div>
        ...
        >
          <div className="form-section p-2 md:p-4">
            {/* ผมเดาว่า Component Step 4 ของ BN น่าจะชื่อประมาณนี้นะครับ */}
            <SharedFormStep4 {...formStepProps} totalWeightFieldName="calculations.finalTotalWeight" formType = "BN" />
          </div>
        </div>
