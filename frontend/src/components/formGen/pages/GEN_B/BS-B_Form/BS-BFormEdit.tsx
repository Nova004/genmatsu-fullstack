...
const BS_BFormEdit: React.FC<BS_BFormEditProps> = ({ initialData, onSubmit, onResubmit, status, templates }) => {
    ...
    const availableForms = [{ value: 'G013', label: 'BS-B', path: '#' }]; // ไม่จำเป็นต้องมี path จริงในโหมดแก้ไข
                    ...
                    */}
                    ...
                    {step === 2 && (
                        <FormStep2
                            ...
                            staticBlueprint={status === 'Approved' && templates ? templates['BS-B_Step2_RawMaterials'] : undefined}
                        />
                    )}
                    {step === 3 && (
                        <SharedFormStep3
                            ...
                            getValues={getValues}
                            onTemplateLoaded={() => { }}
                            templateName="BS-B_Step3_Operations"
                            // 👇 Pass logic Approved ? Old : New
                            staticBlueprint={status === 'Approved' && templates ? templates['BS-B_Step3_Operations'] : undefined}
                        />
                    )}
