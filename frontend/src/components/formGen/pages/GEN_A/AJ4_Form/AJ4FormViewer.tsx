// src/components/formGen/pages/AJ4_Form/AJ4FormViewer.tsx
...
// สร้าง Interface เพื่อกำหนดว่า AJ4FormViewer ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface AJ4FormViewerProps {
...
// --- ส่วน Component หลัก ---
const AJ4FormViewer: React.FC<AJ4FormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['AJ4_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['AJ4_Step3_Operations']} templateName="AJ4_Step3_Operations" />}
