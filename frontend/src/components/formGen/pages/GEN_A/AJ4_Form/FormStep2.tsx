// path: frontend/src/components/formGen/pages/GEN_A/AJ4_Form/FormStep2.tsx
...
export const useExcelFormulaCalculations = (
  ...
  const [
    ...
    'rawMaterials.calciumbromide',
    'rawMaterials.remainedGenmatsu.actual',
    'rawMaterials.magnesiumstearate',
  ...
  useEffect(() => {
    ...
    const total =
      (Number(net) || 0) +
      (Number(calciumbromide) || 0) +
      (Number(activatedcarbon) || 0) +
      (Number(magnesiumstearate) || 0) +
      (Number(remainedGenmatsu) || 0) +
      (Number(IronOxideMTY80) || 0) +
...
const FormStep2: React.FC<FormStep2Props> = ({
  ...
  const { fields, isLoading, error } = useTemplateLoader({
    templateName: 'AJ4_Step2_RawMaterials', // 👈 แค่ระบุชื่อ Template ที่ถูกต้อง
    onTemplateLoaded,
    staticBlueprint,
  });
      ...
      <div className="rounded-b-sm border border-t-0 border-stroke p-5 dark:border-strokedark">
        ...
        <div className="overflow-x-auto">
          <table className="w-full table-auto">
            <tbody>
              <tr>
                <td className={tdLeftClass}> Iron Powder  MG-1179 :Weight</td>
              ...
              <tr>
                ...
                <td className={tdLeftClass} colSpan={4} style={{ fontSize: 'small' }}>Total weight (Kg.) = Iron Powder MG-1179+Magnesium Stearate+Calcium bromide+Iron oxide MTY-80+Carbon A3+Remained Genmatsu (+ NCR Genmatsu)</td>
              </tr>
              <tr>
