...
const AJ4FormEdit: React.FC<AJ4FormEditProps> = ({ initialData, onSubmit, onResubmit, submissionId, status }) => {
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                ...
                <div className="my-6">
                    ...
                    */}
                    ...
                    {step === 3 && <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={() => { }} templateName="AJ4_Step3_Operations" />}
