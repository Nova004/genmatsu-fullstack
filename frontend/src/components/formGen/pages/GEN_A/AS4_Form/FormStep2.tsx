// path: frontend/src/components/formGen/pages/GEN_A/AS4_Form/FormStep2.tsx
...
const FormStep2: React.FC<FormStep2Props> = ({
  ...
  const { fields, isLoading, error } = useTemplateLoader({
    templateName: 'AS4_Step2_RawMaterials', // 👈 แค่ระบุชื่อ Template ที่ถูกต้อง
    onTemplateLoaded,
    staticBlueprint,
  });
          ...
          <table className="w-full table-auto">
            <tbody>
              ...
              <tr>
                ...
                <td className={tdLeftClass} colSpan={4} style={{ fontSize: 'small' }}>Total weight (Kg.) = Iron Powder HGN 82.29.01+Sodium bromide+Carbon …....+Perlite (+Remained Genmatsu/NCR Genmatsu)</td>
              </tr>
              <tr>
