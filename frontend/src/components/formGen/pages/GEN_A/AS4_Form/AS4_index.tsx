// frontend/src/components/formGen/pages/AS4_Form/AS4_index.tsx 
...
function AS4_Form() {
    ...
    const { step, handleNext, handleBack } = useMultiStepForm({
        ...
        trigger,
        errors,
        validationSchema: AS4_VALIDATION_SCHEMA as any
    });
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="my-6">
                        ...
                        <div className={step !== 3 ? 'hidden' : ''}>
                            <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={handleTemplateLoaded} templateName="AS4_Step3_Operations" />
                        </div>
