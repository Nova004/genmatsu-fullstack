// src/components/formGen/pages/AS4_Form/AS4FormViewer.tsx
...
// สร้าง Interface เพื่อกำหนดว่า AS4FormViewer ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface AS4FormViewerProps {
...
// --- ส่วน Component หลัก ---
const AS4FormViewer: React.FC<AS4FormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        <FormHeader
          ...
          formTypes={[{ value: 'G007', label: 'AS4', path: '#' }]}
          currentValue="G007"
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['AS4_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['AS4_Step3_Operations']} templateName="AS4_Step3_Operations" />}
