...
const AS2FormEdit: React.FC<AS2FormEditProps> = ({ initialData, onSubmit, onResubmit, submissionId, status, templates }) => {
    ...
    const availableForms = [{ value: 'G001', label: 'AS2', path: '#' }]; // ไม่จำเป็นต้องมี path จริงในโหมดแก้ไข
                    ...
                    */}
                    ...
                    {step === 2 && (
                        <FormStep2
                            ...
                            staticBlueprint={status === 'Approved' && templates ? templates['AS2_Step2_RawMaterials'] : undefined}
                        />
                    )}
                    {step === 3 && (
                        <SharedFormStep3
                            ...
                            getValues={getValues}
                            onTemplateLoaded={() => { }}
                            templateName="AS2_Step3_Operations"
                            // 👇 Pass logic Approved ? Old : New
                            staticBlueprint={status === 'Approved' && templates ? templates['AS2_Step3_Operations'] : undefined}
                        />
                    )}
