// path: frontend/src/components/formGen/pages/GEN_A/AZ_Form/FormStep2.tsx
...
export const useExcelFormulaCalculations = (
  ...
  const [
    ...
    'rawMaterials.AZRGenmatsu.actual',
  ]);
...
const FormStep2: React.FC<FormStep2Props> = ({
  ...
  const { fields, isLoading, error } = useTemplateLoader({
    templateName: 'AZ_Step2_RawMaterials', // 👈 แค่ระบุชื่อ Template ที่ถูกต้อง
    onTemplateLoaded,
    staticBlueprint,
  });
  ...
  useWeightingCalculation(watch, setValue, AZWeightingConfig);
          ...
          <table className="w-full table-auto">
            <tbody>
              ...
              <tr>
                ...
                <td className={tdLeftClass} colSpan={4} style={{ fontSize: 'small' }}>* Total weight (Kg.) = Iron Powder HGN 82.29.04 + Sodium Chloride + Carbon A  + Remained Genmatsu (+ NCR Genmatsu + AZ-R)</td>
              </tr>
              <tr>
