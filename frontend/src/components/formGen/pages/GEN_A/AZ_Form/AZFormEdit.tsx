...
const AZFormEdit: React.FC<AZFormEditProps> = ({ initialData, onSubmit, onResubmit, submissionId, status }) => {
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                ...
                <div className="my-6">
                    ...
                    */}
                    ...
                    {step === 3 && <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={() => { }} templateName="AZ_Step3_Operations" />}
