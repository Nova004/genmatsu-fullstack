// frontend/src/components/formGen/pages/AS2-D_Form/AS2-D_index.tsx 
...
function AS2_D_Form() {
    ...
    const { step, handleNext, handleBack } = useMultiStepForm({
        ...
        trigger,
        errors,
        validationSchema: AS2_D_VALIDATION_SCHEMA as any
    });
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="my-6">
                        ...
                        <div className={step !== 3 ? 'hidden' : ''}>
                            <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={handleTemplateLoaded} templateName="AS2-D_Step3_Operations" />
                        </div>
