// path: frontend/src/components/formGen/pages/GEN_A/AS2-D_Form/FormStep2.tsx
...
const FormStep2: React.FC<FormStep2Props> = ({
  ...
  const { fields, isLoading, error } = useTemplateLoader({
    templateName: 'AS2-D_Step2_RawMaterials', // 👈 แค่ระบุชื่อ Template ที่ถูกต้อง
    onTemplateLoaded,
    staticBlueprint,
  });
          ...
          <table className="w-full table-auto">
            <tbody>
              ...
              <tr>
                ...
                <td className={tdLeftClass} colSpan={4} style={{ fontSize: 'small' }}>Total weight (Kg.) = Iron Powder HGS InSIP 100.22+Calcium chloride+Carbon HR-G1+Perlite+Sulfur+Remained Genmatsu (+NCR Genmatsu)</td>
              </tr>
              <tr>
