// src/components/formGen/pages/AZ1_Form/AZ1FormViewer.tsx
...
// --- ส่วน Component หลัก ---
const AZ1FormViewer: React.FC<AZ1FormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        <FormHeader
          ...
          formTypes={[{ value: 'G022', label: 'AZ1', path: '#' }]}
          currentValue="G022"
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['AZ1_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['AZ1_Step3_Operations']} templateName="AZ1_Step3_Operations" />}
