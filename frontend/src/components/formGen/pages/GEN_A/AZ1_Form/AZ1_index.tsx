// frontend/src/components/formGen/pages/AZ1_Form/AZ1_index.tsx 
...
function AZ1_Form() {
    ...
    const { step, handleNext, handleBack } = useMultiStepForm({
        ...
        trigger,
        errors,
        validationSchema: AZ1_VALIDATION_SCHEMA, // 👈 ใช้ Schema ใหม่
    });
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="my-6">
                        ...
                        <div className={step !== 3 ? 'hidden' : ''}>
                            <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={handleTemplateLoaded} templateName="AZ1_Step3_Operations" />
                        </div>
