// path: frontend/src/components/formGen/pages/GEN_A/AZ1_Form/FormStep2.tsx
...
const FormStep2: React.FC<FormStep2Props> = ({
  ...
  const { fields, isLoading, error } = useTemplateLoader({
    templateName: 'AZ1_Step2_RawMaterials', // 👈 แค่ระบุชื่อ Template ที่ถูกต้อง
    onTemplateLoaded,
    staticBlueprint,
  });
  ...
  useWeightingCalculation(watch, setValue, AZ1WeightingConfig);
