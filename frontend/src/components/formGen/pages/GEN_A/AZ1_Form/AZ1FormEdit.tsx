...
const AZ1FormEdit: React.FC<AZ1FormEditProps> = ({ initialData, onSubmit, onResubmit, submissionId, status }) => {
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                ...
                <div className="my-6">
                    ...
                    */}
                    ...
                    {step === 3 && <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={() => { }} templateName="AZ1_Step3_Operations" />}
