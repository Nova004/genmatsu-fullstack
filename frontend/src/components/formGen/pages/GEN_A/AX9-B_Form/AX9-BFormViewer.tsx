// src/components/formGen/pages/AX9-B_Form/AX9-BFormViewer.tsx
...
interface AX9_BFormViewerProps {
...
// --- ส่วน Component หลัก ---
const AX9_BFormViewer: React.FC<AX9_BFormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['AX9-B_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['AX9-B_Step3_Operations']} templateName="AX9-B_Step3_Operations" />}
...
export default AX9_BFormViewer;