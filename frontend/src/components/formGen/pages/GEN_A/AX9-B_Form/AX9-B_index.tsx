// frontend/src/components/formGen/pages/AX9-B_Form/AX9-B_index.tsx 
...
function AX9_B_Form() {
    ...
    const { step, handleNext, handleBack } = useMultiStepForm({
        ...
        trigger,
        errors,
        validationSchema: AX9_B_VALIDATION_SCHEMA, // 👈 ใช้ Schema ใหม่
    });
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="my-6">
                        ...
                        <div className={step !== 3 ? 'hidden' : ''}>
                            <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={handleTemplateLoaded} templateName="AX9-B_Step3_Operations" />
                        </div>
