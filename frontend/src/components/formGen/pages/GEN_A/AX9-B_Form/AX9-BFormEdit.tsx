...
const AX9_BFormEdit: React.FC<AX9_BFormEditProps> = ({ initialData, onSubmit, onResubmit, submissionId, status }) => {
    ...
    const availableForms = [{ value: 'AX9-B', label: 'AX9-B', path: '#' }]; // ไม่จำเป็นต้องมี path จริงในโหมดแก้ไข
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                ...
                <div className="my-6">
                    ...
                    */}
                    ...
                    {step === 3 && <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={() => { }} templateName="AX9-B_Step3_Operations" />}
