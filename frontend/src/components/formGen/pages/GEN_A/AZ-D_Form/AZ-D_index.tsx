// frontend/src/components/formGen/pages/AZ-D_Form/AZ-D_index.tsx 
...
function AZ_D_Form() {
    ...
    const { step, handleNext, handleBack } = useMultiStepForm({
        ...
        trigger,
        errors,
        validationSchema: AZ_D_VALIDATION_SCHEMA as any
    });
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="my-6">
                        ...
                        <div className={step !== 3 ? 'hidden' : ''}>
                            <SharedFormStep3 register={register} errors={errors} trigger={trigger} control={control} getValues={getValues} onTemplateLoaded={handleTemplateLoaded} templateName="AZ-D_Step3_Operations" />
                        </div>
