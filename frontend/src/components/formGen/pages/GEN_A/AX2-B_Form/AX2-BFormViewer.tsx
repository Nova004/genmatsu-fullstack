// src/components/formGen/pages/AX2-B_Form/AX2-BFormViewer.tsx
...
// สร้าง Interface เพื่อกำหนดว่า AX2-BFormViewer ต้องรับข้อมูลอะไรเข้ามาบ้าง
interface AX2_BFormViewerProps {
...
// --- ส่วน Component หลัก ---
const AX2_BFormViewer: React.FC<AX2_BFormViewerProps> = ({ formData, blueprints, isReadOnly }) => {
    ...
    <FormProvider {...methods}>
      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
        <FormHeader
          ...
          formTypes={[{ value: 'AX2-B', label: 'AX2-B', path: '#' }]}
          currentValue="AX2-B"
        ...
        <div className="my-6">
          ...
          {step === 2 && <FormStep2 {...formStepProps} staticBlueprint={blueprints['AX2-B_Step2_RawMaterials']} />}
          {/* ถ้า `step` เท่ากับ 3 ก็ทำเหมือน Step 2 */}
          {step === 3 && <SharedFormStep3 {...formStepProps} staticBlueprint={blueprints['AX2-B_Step3_Operations']} templateName="AX2-B_Step3_Operations" />}
...
export default AX2_BFormViewer;