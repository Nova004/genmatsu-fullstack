// path: frontend/src/components/formGen/pages/GEN_A/AX2-B_Form/FormStep2.tsx
...
export const useExcelFormulaCalculations = (
  ...
  useEffect(() => {
    ...
    const finalValue = formatNumberRound(total);
...
const FormStep2: React.FC<FormStep2Props> = ({
  ...
  const { fields, isLoading, error } = useTemplateLoader({
    templateName: 'AX2-B_Step2_RawMaterials', // 👈 แค่ระบุชื่อ Template ที่ถูกต้อง
    onTemplateLoaded,
    staticBlueprint,
  });
      ...
      <div className="rounded-b-sm border border-t-0 border-stroke p-5 dark:border-strokedark">
        ...
        <div className="overflow-x-auto">
          <table className="w-full table-auto">
            <tbody>
              <tr>
                <td className={tdLeftClass}>Iron Powder JIP-303A-60 :Weight</td>
