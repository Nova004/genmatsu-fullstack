                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/master/form-editor" // <-- ลิงก์ไปที่ route ใหม่
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              {/* อาจจะใส่ SVG Icon ของ "Settings" หรือ "Edit" ตรงนี้ได้ */}
                              Form Master
                            </NavLink>
                          </li>
                          ...
                          <li>
                            <NavLink
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('nacl-master') &&
                                'bg-graydark dark:bg-meta-4'
                                }`}
                            >
                              NaCl Master
