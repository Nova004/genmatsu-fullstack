// location: frontend/src/pages/Reports/BZ3/ReportEditBZ3.tsx

import React from 'react';
import { useNavigate } from 'react-router-dom';
import BZ3FormEdit from '../../../components/formGen/pages/GEN_B/BZ3_Form/BZ3FormEdit';
import { updateSubmission, resubmitSubmission } from '../../../services/submissionService'; // สร้างฟังก์ชันนี้ในขั้นตอนต่อไป
import { fireToast } from '../../../hooks/fireToast';
import Swal from 'sweetalert2';

interface ReportEditBZ3Props {
    submission: any;
    templates: any;
}

const ReportEditBZ3: React.FC<ReportEditBZ3Props> = ({ submission, templates }) => {
    const navigate = useNavigate();

    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ BZ3_Form ต้องการ
    const initialData = {
