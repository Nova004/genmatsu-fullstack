// location: frontend/src/pages/Reports/AS2_D/ReportEditAS2_D.tsx

import React from 'react';
import AS2_DFormEdit from '../../../components/formGen/pages/GEN_A/AS2-D_Form/AS2-DFormEdit';
...
interface ReportEditAS2_DProps {
    submission: any;
    templates: any;
}

const ReportEditAS2_D: React.FC<ReportEditAS2_DProps> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ AS2_D_Form ต้องการ
    const initialData = {
    ...
    const { handleUpdate } = useUpdateSubmission({
        submission,
        redirectPath: '/reports/history/gen-a'
    });
...
export default ReportEditAS2_D;