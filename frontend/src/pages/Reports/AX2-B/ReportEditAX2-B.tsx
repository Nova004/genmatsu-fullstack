// location: frontend/src/pages/Reports/AX2-B/ReportEditAX2-B.tsx
...
interface ReportEditAX2_BProps {
    submission: any;
    templates: any;
}

const ReportEditAX2_B: React.FC<ReportEditAX2_BProps> = ({ submission, templates }) => {
    const { user } = useAuth();

    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ AX2-B_Form ต้องการ
    const initialData = {
...
export default ReportEditAX2_B;