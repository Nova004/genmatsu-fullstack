// location: frontend/src/pages/Reports/AS4/ReportEditAS4.tsx

import React from 'react';
import AS4FormEdit from '../../../components/formGen/pages/GEN_A/AS4_Form/AS4FormEdit';
...
interface ReportEditAS4Props {
    submission: any;
    templates: any;
}

const ReportEditAS4: React.FC<ReportEditAS4Props> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ AS4_Form ต้องการ
    const initialData = {
