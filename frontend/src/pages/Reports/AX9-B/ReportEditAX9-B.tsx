// location: frontend/src/pages/Reports/AX9-B/ReportEditAX9-B.tsx

import React from 'react';
import AX9_BFormEdit from '../../../components/formGen/pages/GEN_A/AX9-B_Form/AX9-BFormEdit';
...
interface ReportEditAX9_BProps {
    submission: any;
    templates: any;
}

const ReportEditAX9_B: React.FC<ReportEditAX9_BProps> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ AX9-B_Form ต้องการ
    const initialData = {
...
export default ReportEditAX9_B;