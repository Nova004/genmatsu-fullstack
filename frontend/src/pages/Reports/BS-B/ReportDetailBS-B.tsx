// frontend/src/pages/Reports/BS-B/ReportDetailBS-B.tsx

import React from 'react';
import BS_BFormViewer from '../../../components/formGen/pages/GEN_B/BS-B_Form/BS-BFormViewer';
import ApprovalFlowDisplay from "../../../components/formGen/components/forms/ApprovalFlowDisplay";

interface ReportDetailBS_BProps {
  submission: any;
  blueprints: any;
}

const ReportDetailBS_B: React.FC<ReportDetailBS_BProps> = ({ submission, blueprints }) => {
...
export default ReportDetailBS_B;