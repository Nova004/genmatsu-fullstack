// location: frontend/src/pages/Reports/AZ1/ReportEditAZ1.tsx

import React from 'react';
import AZ1FormEdit from '../../../components/formGen/pages/GEN_A/AZ1_Form/AZ1FormEdit';
...
interface ReportEditAZ1Props {
    submission: any;
    templates: any;
}

const ReportEditAZ1: React.FC<ReportEditAZ1Props> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ AZ1_Form ต้องการ
    const initialData = {
