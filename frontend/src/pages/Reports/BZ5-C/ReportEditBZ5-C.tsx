...
import BZ5_CFormEdit from '../../../components/formGen/pages/GEN_B/BZ5-C_Form/BZ5-CFormEdit';
import { updateSubmission } from '../../../services/submissionService'; // สร้างฟังก์ชันนี้ในขั้นตอนต่อไป
import { fireToast } from '../../../hooks/fireToast';
import Swal from 'sweetalert2';

interface ReportEditBZ5_CProps {
    submission: any;
    templates: any;
}

const ReportEditBZ5_C: React.FC<ReportEditBZ5_CProps> = ({ submission, templates }) => {
...
export default ReportEditBZ5_C;