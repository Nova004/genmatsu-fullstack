// location: frontend/src/pages/Reports/BS3-C/ReportEditBS3-C.tsx

import React from 'react';
import BS3_CFormEdit from '../../../components/formGen/pages/GEN_B/BS3-C_Form/BS3-CFormEdit';
...
interface ReportEditBS3_CProps {
    submission: any;
    templates: any;
}

const ReportEditBS3_C: React.FC<ReportEditBS3_CProps> = ({ submission, templates }) => {
    const { user } = useAuth();

    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ BS3-C_Form ต้องการ
    const initialData = {
...
export default ReportEditBS3_C;