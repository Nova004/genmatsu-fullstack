// location: frontend/src/pages/Reports/BS3-B1/ReportEditBS3-B1.tsx

import React from 'react';
import BS3_B1FormEdit from '../../../components/formGen/pages/GEN_B/BS3-B1_Form/BS3-B1FormEdit';
...
interface ReportEditBS3_B1Props {
    submission: any;
    templates: any;
}

const ReportEditBS3_B1: React.FC<ReportEditBS3_B1Props> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ BS3-B1_Form ต้องการ
    const initialData = {
...
export default ReportEditBS3_B1;