// location: frontend/src/pages/Reports/AJ4/ReportEditAJ4.tsx

import React from 'react';
import AJ4FormEdit from '../../../components/formGen/pages/GEN_A/AJ4_Form/AJ4FormEdit';
...
interface ReportEditAJ4Props {
    submission: any;
    templates: any;
}

const ReportEditAJ4: React.FC<ReportEditAJ4Props> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ AJ4_Form ต้องการ
    const initialData = {
