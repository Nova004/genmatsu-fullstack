// location: frontend/src/pages/Reports/AZ/ReportEditAZ.tsx

import React from 'react';
import AZFormEdit from '../../../components/formGen/pages/GEN_A/AZ_Form/AZFormEdit';
...
interface ReportEditAZProps {
    submission: any;
    templates: any;
}

const ReportEditAZ: React.FC<ReportEditAZProps> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ AZ_Form ต้องการ
    const initialData = {
