// location: frontend/src/pages/Reports/BS3/ReportEditBS3.tsx

import React from 'react';
import { useNavigate } from 'react-router-dom';
import BS3FormEdit from '../../../components/formGen/pages/GEN_B/BS3_Form/BS3FormEdit';
import { updateSubmission } from '../../../services/submissionService'; // สร้างฟังก์ชันนี้ในขั้นตอนต่อไป
import { fireToast } from '../../../hooks/fireToast';
import Swal from 'sweetalert2';

interface ReportEditBS3Props {
    submission: any;
    templates: any;
}

const ReportEditBS3: React.FC<ReportEditBS3Props> = ({ submission, templates }) => {
    const navigate = useNavigate();

    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ BS3_Form ต้องการ
    const initialData = {
