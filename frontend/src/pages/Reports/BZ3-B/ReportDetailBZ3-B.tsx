// frontend/src/pages/Reports/BZ3-B/ReportDetailBZ3-B.tsx

import React from 'react';
import BZ3_BFormViewer from '../../../components/formGen/pages/GEN_B/BZ3-B_Form/BZ3-BFormViewer';
import ApprovalFlowDisplay from "../../../components/formGen/components/forms/ApprovalFlowDisplay";

interface ReportDetailBZ3_BProps {
  submission: any;
  blueprints: any;
}

const ReportDetailBZ3_B: React.FC<ReportDetailBZ3_BProps> = ({ submission, blueprints }) => {
...
export default ReportDetailBZ3_B;