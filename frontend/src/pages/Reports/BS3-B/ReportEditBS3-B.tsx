// location: frontend/src/pages/Reports/BS3-B/ReportEditBS3-B.tsx

import React from 'react';
import { useNavigate } from 'react-router-dom';
import BS3_BFormEdit from '../../../components/formGen/pages/GEN_B/BS3-B_Form/BS3-BFormEdit';
import { updateSubmission, resubmitSubmission } from '../../../services/submissionService'; // สร้างฟังก์ชันนี้ในขั้นตอนต่อไป
import { fireToast } from '../../../hooks/fireToast';
import Swal from 'sweetalert2';

interface ReportEditBS3_BProps {
    submission: any;
    templates: any;
}

const ReportEditBS3_B: React.FC<ReportEditBS3_BProps> = ({ submission, templates }) => {
    const navigate = useNavigate();

    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ BS3-B_Form ต้องการ
    const initialData = {
...
export default ReportEditBS3_B;