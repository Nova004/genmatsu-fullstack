...
const ReportHistory_GEN_B: React.FC = () => {
  ...
  const { submissions, totalRows, isLoading, error, fetchSubmissions } = useReportHistoryData('GEN_B');
  ...
  useEffect(() => {
    if (location.state?.highlightedId) {
      ...
      const timer = setTimeout(() => {
        ...
        // Clear from history state so it doesn't re-appear on refresh (optional but good UX)
