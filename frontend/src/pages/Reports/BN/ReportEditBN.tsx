// location: frontend/src/pages/Reports/BN/ReportEditBN.tsx

import React from 'react';
import BNFormEdit from '../../../components/formGen/pages/GEN_B/BN_Form/BNFormEdit';
...
interface ReportEditBNProps {
    submission: any;
    templates: any;
}

const ReportEditBN: React.FC<ReportEditBNProps> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ BN_Form ต้องการ
    const initialData = {
