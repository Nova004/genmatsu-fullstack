...
import BSFormPrint from '../../../components/formGen/pages/GEN_B/BS_Form/BSFormPrint';
import ApprovalFlowDisplay from "../../../components/formGen/components/forms/ApprovalFlowDisplay";

interface ReportDetailBSProps {
  submission: any;
  blueprints: any;
}

const ReportDetailBS: React.FC<ReportDetailBSProps> = ({ submission, blueprints }) => {
