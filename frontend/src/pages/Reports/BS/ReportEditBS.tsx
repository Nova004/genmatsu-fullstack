// location: frontend/src/pages/Reports/BS/ReportEditBS.tsx

import React from 'react';
import BSFormEdit from '../../../components/formGen/pages/GEN_B/BS_Form/BSFormEdit';
...
interface ReportEditBSProps {
    submission: any;
    templates: any;
}

const ReportEditBS: React.FC<ReportEditBSProps> = ({ submission, templates }) => {
    const { user } = useAuth();
    // แปลงข้อมูลที่ดึงมาให้อยู่ในรูปแบบที่ BS_Form ต้องการ
    const initialData = {
